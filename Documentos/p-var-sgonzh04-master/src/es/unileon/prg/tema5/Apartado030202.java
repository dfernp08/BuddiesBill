 ...
 */
    ...
    */
       public void ejercicio02() {
         ...
         StringBuffer cadena=new StringBuffer("Viaje al Parnaso");
      // Modificaciones
	String mitico = "mitico";
	char M = 'M';
	//Ambos son para insertar los caracteres de arriba en la posición 9
    ...
    */
	...
	System.out.println(cadena.toString().replaceAll("l", ""));
      }
